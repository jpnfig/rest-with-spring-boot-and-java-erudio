...
public class PersonController {
	...
	/*  public List<PersonVO> findAll(){ > AQUI RETORNA TUDO EM 1 PÁGINA */
	 ...
	 * MediaType.APPLICATION_YML}) public PersonVOV2 createV2(
	 * 
	 * @RequestBody PersonVOV2 person){ return service.createV2(person); }
	 */
